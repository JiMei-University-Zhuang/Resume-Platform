...
// AI职业分析API
export const aiProfessionAnalysis = async (data: CareerAnalysisForm): Promise<CareerAnalysisResult> => {
  // 实际项目中应该调用后端AI API
  return new Promise(resolve => {
    setTimeout(() => {
      resolve({
...
// AI职业发展规划API
export const aiProfessionRoadmap = async (data: CareerRoadmapForm): Promise<CareerRoadmapResult> => {
  // 实际项目中应该调用后端AI API
  return new Promise(resolve => {
    setTimeout(() => {
      resolve({
...
// AI职业推荐API
export const aiProfessionRecommendation = async (data: CareerRecommendationForm): Promise<CareerRecommendationResult> => {
  // 实际项目中应该调用后端AI API
  return new Promise(resolve => {
    setTimeout(() => {
      resolve({
