                ...
                children: [
                    {
                        ...
                        name: 'CareerAnalysis',
                        component: () =>
                            import('@/views/career-planning/Analysis.vue'),
                        meta: { title: '职业分析' }
                    },
                    {
                        path: 'roadmap',
                        name: 'CareerRoadmap',
                        component: () =>
                            import('@/views/career-planning/Roadmap.vue'),
                        meta: { title: '发展规划' }
                    },
                    {
                        path: 'recommendation',
                        ...
                        component: () =>
                            import(
                                '@/views/career-planning/Recommendation.vue'
                            ),
                        meta: { title: '职业推荐' }
                    }
                ]
                ...
                children: [
                    {
                        ...
                        name: 'CivilService',
                        component: () =>
                            import('@/views/exam/CivilService.vue'),
                        meta: { title: '公务员考试' }
                    },
                    {
                        path: 'postgraduate',
                        name: 'Postgraduate',
                        component: () =>
                            import('@/views/exam/Postgraduate.vue'),
                        meta: { title: '考研备考' }
                    },
                    {
                        path: 'ExamPage',
