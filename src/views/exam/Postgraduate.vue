<template>
  <div class="postgraduate">
    <el-container>
      <el-header class="header">
        ...
        <el-button-group class="category-buttons">
          ...
          <el-button :type="currentCategory === 'civil_service' ? 'primary' : ''" @click="filterCards('math')">
            数学
          </el-button>
          <el-button :type="currentCategory === 'civil_service' ? 'primary' : ''" @click="filterCards('english')">
            英语
          </el-button>
          <el-button :type="currentCategory === 'postgraduate' ? 'primary' : ''" @click="filterCards('politics')">
            政治
          </el-button>
          <el-button :type="currentCategory === 'postgraduate' ? 'primary' : ''" @click="filterCards('professional')">
            专业课
          </el-button>
      ...
      <el-main>
        <div class="card-container">
          <el-card v-for="(paper, index) in filteredPapers" :key="index" class="exam-card">
            ...
            <el-button type="primary" @click="openExamDialog(paper)">
              使用试卷
            </el-button>
    ...
    <el-dialog v-model="isExamDialogVisible" title="开始考试">
      <img :src="currentExamPaper.imageUrl" alt="试卷封面"
...
import { ElContainer, ElHeader, ElMain, ElButton, ElButtonGroup, ElCard, ElDialog } from 'element-plus';
