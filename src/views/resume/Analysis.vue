...
const driverObj = driver({
  showProgress: true,
  steps: [
    { element: '.page-header', popover: { title: '简历匹配分析', description: '这里是简历匹配分析工具，帮助您分析简历与目标岗位的匹配度', side: "bottom", align: 'start' }},
    { element: '.upload-section', popover: { title: '上传简历', description: '在这里上传您的简历文件，支持PDF和Word格式', side: "left", align: 'start' }},
    { element: '.selection-section', popover: { title: '选择目标岗位', description: '选择您想要应聘的岗位类别和具体职位', side: "right", align: 'start' }},
    { element: '.analysis-btn', popover: { title: '开始分析', description: '点击按钮开始分析简历与岗位的匹配度', side: "bottom", align: 'start' }},
