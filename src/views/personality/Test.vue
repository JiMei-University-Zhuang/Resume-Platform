                ...
                <el-collapse v-model="activeCollapse">
                    <el-collapse-item title="MBTI 性格类型" name="1">
                        <div class="mbti-result">
                            ...
                            <div class="trait-bars">
                                <div
                                    v-for="(trait, index) in report.mbti.traits"
                                    :key="index"
                                    class="trait-bar"
                                >
                                    <span>{{ trait.name }}</span>
                                    <el-progress
                                        :percentage="trait.value"
                    ...
                    <el-collapse-item title="大五人格分析" name="2">
                        <div class="big5-result">
                            <div
                                v-for="(dimension, index) in report.bigFive"
                                :key="index"
                                class="dimension"
                            >
                    ...
                    <el-collapse-item title="AI 深度洞察" name="3">
                        <div class="ai-insights">
                            <div
                                v-for="(insight, index) in report.aiInsights"
                                :key="index"
                                class="insight"
                            >
                                <h4>{{ insight.title }}</h4>
