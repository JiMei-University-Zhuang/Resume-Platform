        ...
        <el-card class="upload-area">
            ...
            <div class="content">
                    ...
                    <div class="settings-panel">
                        ...
                        <el-form :model="photoSettings" label-width="100px">
                            ...
                            <el-form-item label="智能美化">
                                ...
                                />
                                <div
                                    v-if="photoSettings.aiBeautify"
                                    class="ai-beautify-options"
                                >
                                    <el-checkbox-group
                                        v-model="
                                            photoSettings.aiBeautifyOptions
                                        "
                                    >
                                        <el-checkbox label="skin"
                                            >智能美肤</el-checkbox
                                        >
                                        <el-checkbox label="face"
                                            >五官优化</el-checkbox
                                        >
                                        <el-checkbox label="wrinkle"
                                            >祛皱</el-checkbox
                                        >
                                    </el-checkbox-group>
                                </div>
                            ...
                            <el-form-item label="着装建议">
                                <el-switch
                                    v-model="
                                        photoSettings.showDressingSuggestions
                                    "
                                    active-text="显示"
                                    inactive-text="隐藏"
                                />
                ...
                <div class="right-panel">
                    ...
                    <div
                        v-if="photoSettings.showDressingSuggestions"
                        class="suggestions"
                    >
                        <h3>着装建议</h3>
                        <el-alert
