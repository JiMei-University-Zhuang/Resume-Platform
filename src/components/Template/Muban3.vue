            ...
            <div class="left-column">
                <div class="photo-section">
                    <div
                        :class="[
                            'photo-container',
                            profilePic ? 'photo-container-finished' : ''
                        ]"
                    >
                ...
                <div class="info-section">
                    ...
                    <div class="personal-info">
                        ...
                        <ul>
                            <li>
                                <span>性　　别：</span>{{ resumeForm.gender }}
                            </li>
                            <li>
                                <span>出生年月：</span
                                >{{ formatDate(resumeForm.birthday) }}
                            </li>
                            <li>
                                <span>籍　　贯：</span>{{ resumeForm.origin }}
                            </li>
                            <li>
                                <span>政治面貌：</span
                                >{{ resumeForm.politicalStatus }}
                            </li>
                            <li>
                                <span>专　　业：</span
                                >{{ resumeForm.education[0]?.major || '' }}
                            </li>
                            <li>
                                <span>学　　历：</span
                ...
                <div class="section skills-section">
                    ...
                    <div class="section-content">
                        ...
                        <div
                            ...
                            v-if="resumeForm.certifications"
                        >
                            <h4>技能证书</h4>
