        ...
        <div class="resume">
                ...
                <section class="skills">
                    ...
                    <ul>
                        <li
                            ...
                            ) in resumeForm.certifications.split('\n')"
                            :key="index"
                        >
                            {{ certifications }}
                        </li>
            ...
            <div class="column2">
                ...
                <section class="work-experience">
                    ...
                    <div class="under-line"></div>
                    <div
                        v-for="(job, index) in resumeForm.experience"
                        :key="index"
                        class="text"
                    >
                        <div class="column1">
                ...
                <section class="honors">
                    ...
                    <ul>
                        <li
                            v-for="(honor, index) in resumeForm.honors.split(
                                '\n'
                            )"
                            :key="index"
                        >
